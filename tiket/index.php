            ...
            <div class="col-md-4">
              <div class="mb-3 mb-md-0">
                <select class="custom-select px-4" style="height: 55px" name="kapal">
                  ...
                  <option value="kecil">Kapal Kecil</option>
                  <option value="sedang">Kapal Sedang</option>
                  <option value="besar">Kapal Besar</option>
                </select>
              </div>
            </div>
            <div class="col-md-4">
  ...
  class Jadwal
  {
    ...
    public function cariJadwal()
    {
      ...
      if ($this->tujuan !== null && $this->kapal !== null) {
        ...
        if ($this->kapal == 'kecil') {
          $sql .= " AND muatan BETWEEN 0 and 50";
        } else if ($this->kapal == 'sedang') {
          $sql .= " AND muatan BETWEEN 51 and 100";
        } else {
          $sql .= " AND  muatan BETWEEN 101 and 150";
        }
      } elseif ($this->tujuan !== null) {
        $sql .= " WHERE tujuan='$this->tujuan'";
      } elseif ($this->kapal !== null) {
        if ($this->kapal == 'kecil') {
          $sql .= " WHERE muatan BETWEEN 0 and 50";
        } else if ($this->kapal == 'sedang') {
          $sql .= " WHERE muatan BETWEEN 51 and 100";
        } else {
          $sql .= " WHERE muatan BETWEEN 101 and 150";
        }
      }
